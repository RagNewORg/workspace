...
public class SalesforceEventLocalServiceUtil {
	...
	public static com.liferay.portal.kernel.messaging.MessageBatch getEventsByUser(
		...
		throws com.liferay.portal.kernel.dao.orm.ObjectNotFoundException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getEventsByUser(companyId, userId, fieldNames, ownerId);
	}
	...
	public static com.liferay.portal.kernel.messaging.MessageBatch getEventsByUserName(
		...
		throws com.liferay.portal.kernel.dao.orm.ObjectNotFoundException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getEventsByUserName(companyId, userName, fieldNames, ownerId);
	}
	...
	*/
	...
	private static ServiceTracker<SalesforceEventLocalService, SalesforceEventLocalService> _serviceTracker =
		ServiceTrackerFactory.open(SalesforceEventLocalService.class);
}